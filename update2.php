...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE `category` SET `name`='$name', `description`='$description', `souscategory`='$souscategory' WHERE `category_ID`='$category_ID'";

    $result = mysqli_query($conn, $sql);


   if($result) {
        header("location: displayca.php?msg=New category updated successfully ");
    }
    else{
...
<div class="container">
    ...
    <div class="text-center mb-4">
        ...
        <p class="text-muted"> complete the form to update this category</p>
    </div>
